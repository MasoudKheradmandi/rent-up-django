    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function (e) {
            ...
            var g = this._canAdjustMonth(e, -1, d, p)
                ? '<a class="ui-datepicker-prev btn btn-link" data-handler="prev" data-event="click"' + ' title="' + m + '">' + (n ? '<i class="fas fa-chevron-right"></i>' : '<i class="fas fa-chevron-left"></i>') + "</a>"
                : i
                ? ""
                : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="' + m + '">' + (n ? '<i class="fas fa-chevron-right"></i>' : '<i class="fas fa-chevron-left"></i>') + "</a>";
            ...
            var b = this._canAdjustMonth(e, +1, d, p)
                ? '<a class="ui-datepicker-next btn btn-link" data-handler="next" data-event="click"' + ' title="' + y + '">' + (n ? '<i class="fas fa-chevron-left"></i>' : '<i class="fas fa-chevron-right"></i>') + "</a>"
                : i
                ? ""
                : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="' + y + '">' + (n ? '<i class="fas fa-chevron-left"></i>' : '<i class="fas fa-chevron-right"></i>') + "</a>";
